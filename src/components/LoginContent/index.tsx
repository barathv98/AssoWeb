...
const LoginContent: FC<Props> = ({ closeModal }) => {
    ...
    const onChangeMobileNumber = useCallback((e: any) => {
        ...
        <div className={styles.loginContent}>
            {loginStep === 'mobileNumberForm' ? <>
                ...
                <div className={styles.inputField}>
                    <div className={styles.mobileCode}><CountryFlag /> +91 - </div>
            ...
            : <>
                ...
                {resendOffset === 0
                    ? <div className={styles.resendLink} onClick={onResendOTP}>Resend OTP</div>
