import { getCart, getPODetails, getUserDetail, placeOrder, removeCart, requestOTP, sendEmail, updateCart, verifyOTP, verifyToken } from "./services/Api.service";
import { useMutation } from 'react-query';

export const useRequestRequestOTP = ({
	onSuccess,
	onError,
	params,
}: any): any => {
...
export const useRequestUpdateCart = ({
    onSuccess,
}: any): any => {
...
export const useRequestRemoveCart = ({
    onSuccess,
}: any): any => {
...
export const useRequestGetCart = ({
	onSuccess,
}: any): any => {
...
export const useRequestSendEmail = ({
	onSuccess,
	onError,
	params,
}: any): any => {
...
export const useRequestGetUserDetail = ({
	onSuccess,
}: any): any => {
...
export const useRequestGetPODetails = ({
	onSuccess,
	params,
}: any): any => {
...
export const useRequestPlaceOrder = ({
	onSuccess,
	onError,
	params,
}: any): any => {
